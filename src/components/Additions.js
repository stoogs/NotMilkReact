...
const additions  = (props) => {
    return (
        <div>
            ...
            <input onClick={props.additions} name={props.labels[0]} type="checkbox" value={props.option}  />
            <br/>
            {console.log(props.labels[1], props.options[1])}
            <label>{props.labels[1]}</label>
            <input onClick={props.additions} name={props.labels[1]} type="checkbox" value={props.option}   />
            <br/>
            {console.log(props.labels[2], props.options[2])}
            <label>{props.labels[2]} </label>
            <input onClick={props.additions} name={props.labels[2]} type="checkbox" value={props.option}  />
            <br/>
            {console.log(props.labels[3], props.options[3])}
            <label>{props.labels[3]}</label>
            <input onClick={props.additions} name={props.labels[3]} type="checkbox" value={props.option}  />
            <br/>
            {console.log(props.labels[4], props.options[4])}
            <label>{props.labels[4]}</label>
            <input onClick={props.additions} name={props.labels[4]} type="checkbox" value={props.option}  />
            </div>
    )
}
